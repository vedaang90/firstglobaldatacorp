...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'ved-win@protonmail.com');
define('EMAIL_TO_NAME', 'Vedaang Sharma');

define('EMAIL_TO_CC', 'fgdcharshal@gmail.com');
define('EMAIL_TO_CC_NAME', 'Harshal Galani');

define('EMAIL_TO_BCC', '');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'web@firstglobaldatacorp.com');
define('EMAIL_FROM_NAME', 'FGDC Website');
...
define('SMTP_HOST', 'p3plzcpnl464875.prod.phx3.secureserver.net');
define('SMTP_USER', 'web@firstglobaldatacorp.com');
define('SMTP_PASS', 'test1234');
define('SMTP_AUTH', '');

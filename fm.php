...
//Application Title
define('APP_TITLE', 'Backend | Windows Gaming');
...
$userinfo = array(
    'username' => 'vedaang', //Username
    'password' => 'gta890op' //Password
);
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <img src="<?php echo $favicon_path; ?>" style="width: 100%;" alt="Backend->Windows-Gaming">
                        </div>
                        <div class="text-center">
                            <h1 class="card-title"><?php echo str_replace("Windows Gaming ", "", APP_TITLE); ?></h1>
                        </div>
                        <div class="card fat">
                            <div class="card-body">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash;
                            <a href="https://win-gamer.ga" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Windows Gaming</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Backend->win-gamer.ga';      $tr['en']['AppTitle']           = 'Windows Gaming-Backend';
